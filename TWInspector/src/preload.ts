...
import { CharacterInterface } from '../TotalWarhammerPlanner/frontend/src/types/interfaces/CharacterInterface';
...
export const API = {
  ...
  getCharList: (workspacePath: string): Promise<CharacterListInterface> =>
    ipcRenderer.invoke('dialog:getCharList', workspacePath),
