...
vanilla3CharactersMemes.vmp_vampire_counts.lords.wh_dlc04_skill_node_set_vmp_vlad_von_carstein.name = 'Chad von Carstein';
vanilla3CharactersMemes.vmp_vampire_counts.heroes.wh_dlc04_skill_node_set_vmp_vlad_von_carstein_hero.name = 'Chad von Carstein (Hero)';
