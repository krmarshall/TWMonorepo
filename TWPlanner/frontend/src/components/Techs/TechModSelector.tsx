...
const TechModSelector = () => {
  ...
  return (
    <div className="justify-self-center p-1 w-full bg-gray-700 border rounded-md border-gray-500">
        ...
        {gameKeys.map((gameKey) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="w-fit mx-auto text-center text-gray-300 text-lg text-shadow">{game.category}</h3>
            </li>
          );
        })}
      </ul>
