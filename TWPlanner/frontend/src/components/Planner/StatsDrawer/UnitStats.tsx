...
const UnitStats = () => {
  ...
  const hasBarrier = stats.barrier !== undefined && stats.barrier > 0 ? true : false;
    ...
    <div className="text-gray-50 text-lg">
      ...
      {unitStatSets.length > 1 && (
        <div className="mx-auto mb-1 flex flex-row flex-nowrap w-fit">
          ...
          <select
            className="max-w-48 max-h-7 ml-2 px-1 bg-gray-500 rounded text-xl font-[CaslonAntique]"
            id="mountSelect"
            onChange={(event) => {
