...
import type { WorkerModDataInterface } from '../@types/WorkerDataInterfaces.ts';
...
const { folder, dbList, game, globalData, modInfo, pruneVanilla, tech }: WorkerModDataInterface = workerData;
